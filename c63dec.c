...
void decode_c63_frame(struct c63_common *cm, FILE *fout)
{
    ...
    /* XXX: To dump the predicted frames, use this */
...
static void print_help()
{
    ...
    fprintf(stderr, "\n");
    fprintf(stderr, "Tip! Use mplayer to playback a raw YUV file:\n");
    fprintf(stderr, "  mplayer -demuxer rawvideo -rawvideo w=352:h=288:format=i420 foreman.yuv\n");
    fprintf(stderr, "\n");
